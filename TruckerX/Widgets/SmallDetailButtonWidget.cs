...
namespace TruckerX.Widgets
{
    public class SmallDetailButtonWidget : BaseWidget
    {
        ...
        public SmallDetailButtonWidget(bool flipped = false) : base()
        {
            ...
            this.OnClick += SmallDetailButtonWidget_OnClick;
        }

        private void SmallDetailButtonWidget_OnClick(object sender, EventArgs e)
        {
        ...
        public override void Draw(SpriteBatch batch, GameTime gameTime)
        {
            ...
            else if (this.State == WidgetState.Disabled)
            {
                ...
                float lockW = padlock.Width / 12 * ContentLoader.GetRDMultiplier();
                float lockH = padlock.Height / 12 * ContentLoader.GetRDMultiplier();
